...
<b>Message:</b> <%= objRecordset.Fields("Message") %><p>

<b>Added By:</b> <%= objRecordset.Fields("AddedBy") & " on " & objRecordset.Fields("DateAdded")%>

<p>&nbsp;</p>

  <form method="post" action="/Assembly1955/calendar/edit_event.asp">
	<input type="submit" name="btnEditEvent" value="Edit/Delete Event">
  </form>
