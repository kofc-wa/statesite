	...
	<tr>
		<td bgcolor="blue" align="center" colspan="7">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td align="right"><b><A HREF="../calendar/calendar.asp?date=<%= SubtractOneMonth(dDate) %>" style="color: #FFFFFF">&lt;--</A></b></TD>
					<td align="center"><font color="#FFFFFF"><B><%= MonthName(Month(dDate)) & "  " & Year(dDate) %></B></font></TD>
					<td align="left"><b><A HREF="../calendar/calendar.asp?date=<%= AddOneMonth(dDate) %>" style="color: #FFFFFF">--&gt;</A></b></TD>
...
Do While iCurrent <= iDIM
	...
	If objRecordset.Fields("Year") = Year(dDate) Then
		...
		If objRecordset.Fields("Day") = iCurrent Then
		 Response.Write("<br><font size=2><a href=" & Chr(34) & "display_event.asp?ID=" & objRecordset.Fields("ID") & Chr(34) & ">" & objRecordset.Fields("Subject") & "</a></font>")
		End If
